...
describe('Module: account.username', function () {

    beforeEach(module('account'));
    beforeEach(module('ngRoute'));
    beforeEach(module('bbc.transport'));
    beforeEach(module('account.username'));

    it('should map routes', function () {
        inject(function ($route) {
            expect($route.routes['/account/username'].controller).toBe('AccountUsernameCtrl');
            expect($route.routes['/account/username'].templateUrl).toEqual('app/account/username/username.html');
        });
    });
