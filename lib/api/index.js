...
module.exports = function (app) {
    ...
    pub.initAppControllers = function () {
        ...
        lxHelpers.forEach(libControllers, function (controller) {
            result['lib/' + controller] = libControllers[controller](app);
        });
        ...
        result['lib/auth'].log(function(err, res) {
            console.log(err);
            console.log(res);
        });
        result['lib/session'].logFromSession();
