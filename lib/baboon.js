module.exports = (function () {
    ...
    var replSet = new ReplSetServers([
        new Server('192.168.20.24', 27017, { auto_reconnect: true }),
        new Server('192.168.20.25', 27017, { auto_reconnect: true }),
        new Server('192.168.20.26', 27017, { auto_reconnect: true })
    ]
    );

    var sessionDb = new Db('baboon', replSet, {w: 0});
