...
module.exports = function (rootPath) {
    ...
    var expressConfig = function () {
        ...
        if (config.nodeEnv === 'production') {
            ...
            app.use(log4js.connectLogger(logging.express, {level: 'auto', format: ':method :url :status'}));
            // app.use(log4js.connectLogger(logging.express, {level: log4js.levels.INFO, format: ':method :url :status'}));
        }
