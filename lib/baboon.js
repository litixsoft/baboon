...
module.exports = function (rootPath) {
    ...
    // Session
    baboon.session = require('./session')(baboon.config.session, baboon.loggers.syslog, baboon.rights);
    ...
    baboon.transport.addController(baboon.navigation, 'lib/navigation');

    // Add session to transport
    baboon.transport.addController(baboon.session, 'lib/session');

    // Add account to transport
    baboon.transport.addController(account(baboon.config, baboon.loggers), 'lib/account');
