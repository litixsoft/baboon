module.exports = function (rootPath) {
    ...
    //var parseCookie = require('express').utils.parseCookie;
    // configure socket.io
...
//                if (err || !session || session.url !== url) {
//                    return callback('Error: Session is false or error in session store. ', false);
//                }
...
//            if (data.headers.cookie) {
//                var tmp = parseCookie(data.headers.cookie);
//                RedisSessionStore.get(tmp['baboon.sid'], function (err, session) {
//                    console.log("DIE SESSION");
//                    console.log(session);
//                    return accept(null, true);
////                    if (err || !session || session.url !== url) {
////                        accept('Error: Session is false or error in session store. ', false);
////                    } else if (session.auth && session.auth.loggedIn === true) {
////                        accept(null, true);
////                    } else {
////                        accept('Error: User is not authenticated.', false);
////                    }
//                });
//            } else {
//                return accept('Error: No cookie transmitted.', false);
//            }
        });
    });
