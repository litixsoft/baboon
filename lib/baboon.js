...
module.exports = function (rootPath) {
    ...
    // rights system
    var rights = require('./rights/rights.js')({}, require('./rights/repositories')(config.mongo.rights));

    middleware.errorHandler = require('./middleware/errorHandler')(syslog);
    middleware.auth = require('./middleware/auth')(rights);
    //noinspection JSUnresolvedVariable
    middleware.session = require('./middleware/session')(config.sessionInactiveTime, config.sessionMaxLife);
    ...
    var ss = require('./api').socket(config, logging);
    ...
    io.sockets.on('connection', function (socket) {
        ...
        var acl = rights.getAclObj(session.user.acl);

        ss.register(socket, acl);
    });
