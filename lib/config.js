module.exports = function (rootPath, notice) {
    ...
    //config.path.dist = path.join(rootPath, 'dist');
    config.path.public = path.join(rootPath, 'public');
    config.path.build = path.join(rootPath, 'app', 'build');
    config.path.logs = path.join(rootPath, 'logs');
