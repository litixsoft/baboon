...
//        debug: true,
     ...
     */
    pub.sendMail = function (obj, type, callback) {
        ...
        if(type==='register'){
            ...
            message.text  = 'Vielen Dank für Ihre Registrierung.\n\n' +
                ...
                'http://127.0.0.1:3000/auth/activate:'+obj.guid+'\n\n' +
        ...
        if(type==='forget'){
            message.subject = 'Baboon - Benutzername / Passwort vergessen';
            message.text  = 'Um Ihr Passwort zurückzusetzen klicken Sie bitte auf den folgenden Link:\n\n' +
                'http://127.0.0.1:3000/auth/forget:'+obj.guid+'\n\n' +
                'Falls Sie ihr Passwort bzw. ihren Benutzernamen nicht angefordert haben, können Sie diese Nachricht einfach ignorieren.\n\n' +
                'Mit freundlichen Grüßen\nIhr Litixsoft Team';
        }
