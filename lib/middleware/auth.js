...
module.exports = function (sessionInactiveTime, sessionMaxLife) {
    ...
    var rights = require('../rights/rights.js')({}, require('../rights/repositories')('localhost:27017/baboon_rights?w=0&journal=True&fsync=True'));
        ...
        rights.getUserForLogin(name, function (error, user) {
            ...
            if (!user) {
                ...
                rights.getUser(user._id, function (error, result) {
                    ...
                    console.log(result.hasAccessTo(result, 'example.blog.addComment'));
                    console.log(result.hasAccessTo(result, 'example.blog.wayne'));
