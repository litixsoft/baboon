module.exports = function (sessionInactiveTime) {
    'use strict';

    var users = {admin: {id: 1, name: 'admin'}, andreas: {id: 2, name: 'andreas'}},
        pwd = require('pwd'),
        pub = {};
    ...
    pwd.hash('a', function (err, salt, hash) {
        ...
        users.andreas.salt = salt;
        users.andreas.hash = hash;
    });

    pub.checkSession = function (req, res, next) {
        ...
        if (typeof req.session.user === 'undefined') {
            ...
            // check activity time
            if (sessionInactiveTime < difference) {
