...
module.exports = function (rights, config, logging) {
    ...
    pub.login = function (req, res) {
        ...
        if (typeof username !== 'string' || typeof password !== 'string') {
            logging.syslog.error('Error login: Username and password required and must be a string type.');
            res.json(500, {message: '500: Internal Server Error!'});
        }
        ...
        authenticate(username, password, function (error, result) {
            ...
            if (error) {
                ...
                logging.syslog.error('Error authenticate: No result returned!');
                res.json(500, {message: '500: Internal Server Error!'});
            }
            else {
                ...
                req.session.regenerate(function () {
                    ...
                    res.json(200, {message: 'login successfully'});
