...
// * @returns {{}}
// */
//module.exports.getAclObj = function (acl, config) {
//    var result = {};
//
//    if (config && config.useRightsSystem === false) {
//        // get all rights automatically
//        acl = module.exports.getPublicFunctionsFromControllers(config);
//    }
//
//    lxHelpers.forEach(acl, function (right) {
//        var parts = right.split('/'),
...
//module.exports.secureNavigation = function (user, navigation) {
//    var result = [];
//
//    lxHelpers.forEach(navigation, function (item) {
//        var navItem = lxHelpers.clone(item);
...
//        // process child navigation items
//        if (item.children) {
//            navItem.children = module.exports.secureNavigation(user, item.children);
//        }
//
//        // check if navigation item needs a right/resource to be visible and check if the user has that right/resource
//        if (!item.hasOwnProperty('resource') || module.exports.userHasAccessTo(user, item.resource)) {
//            // delete rigth from navigation item
//            if (navItem.resource) {
//                delete navItem.resource;
//            }
...
//};
//
//module.exports.getPublicFunctionsFromControllers = function (config) {
//    var grunt = require('grunt'),
//        fs = require('fs'),
//        pattern = config.path.modules + '/**/controllers/*.js',
//        controllers = grunt.file.expand(pattern),
...
////    console.log(res);
//
//    var repo = exports.getRepositories(app).rights;
//
//    lxHelpers.forEach(res, function (rightName) {
//        repo.getOne({name: rightName}, function (error, result) {
//            if (error) {
//                console.log(error);
//            } else if (!result) {
...
//
//                    if (result) {
//                        console.log('rights: Created right ' + rightName);
//                    }
//                });
//            }
//        });
