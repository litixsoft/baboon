    ...
    describe('.validate()', function () {
        it('should validate the data', function (done) {
            sut.validate(data, {}, function (err, res) {
                ...
                expect(data.rights[0].equals(sut.convertId('5204cf825dd46a6c15000001'))).toBeTruthy();
                expect(data.rights[1].equals(sut.convertId('5204cf825dd46a6c15000002'))).toBeTruthy();
